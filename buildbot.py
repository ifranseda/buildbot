...
class TestSequence(unittest.TestCase):
    ...
    def test_passing_xcode_case(self):
        ...
        f = FogBugzConnect()
        case = f.fbConnection.new(sProject="Sample Project", sPersonAssignedTo="Jonathan Mason", sTitle="BUILDBOT-passing-xcode-case-test", sFixFor="SampleProject-test", hrsCurrEst="10 minutes")
        create_tests()
